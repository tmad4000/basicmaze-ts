...
$(function () {
    ...
    function checkKeyDown(e) {
        let isARelevantKey = true;
        var code = e.keyCode;

        switch (code) {
            case 37: controlKeys.left = true; break; //Left key
            case 38: controlKeys.up = true; break; //Up key
            case 39: controlKeys.right = true; break; //Right key
            case 40: controlKeys.down = true; break; //Down key
    ...
    function checkKeyUp(e) {
        ...
        switch (code) {
            case 37: controlKeys.left = false; break; //Left key
            case 38: controlKeys.up = false; break; //Up key
            case 39: controlKeys.right = false; break; //Right key
            case 40: controlKeys.down = false; break; //Down key
            default: isARelevantKey = false // alert(code); //Everything else
        }
